...
from rl.monte_carlo.exploring_starts_policy_optimization import monte_carlo_exploring_starts_deterministic_policy_optimization
...
if __name__ == '__main__':
    ...
    optimal_policy, V, Q, deltas = monte_carlo_exploring_starts_deterministic_policy_optimization(game_factory=grid_factory, initial_policy=random_policy, gamma=0.9)
    print('\n\n----------OPTIMIZATION OVER----------')
    print('\ninitial policy:')
