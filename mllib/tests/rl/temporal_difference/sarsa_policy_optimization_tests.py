...
from rl.temporal_difference.sarsa_policy_optimization import temporal_difference_sarsa_policy_evaluation
...
if __name__ == '__main__':
    ...
    optimal_policy, V, Q, history, Q_counts = temporal_difference_sarsa_policy_evaluation(game_factory=grid_factory, gamma=0.9, n_episodes=10000)
    print('\n\n----------OPTIMIZATION OVER----------')
